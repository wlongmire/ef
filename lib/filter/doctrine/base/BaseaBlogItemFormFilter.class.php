...
abstract class BaseaBlogItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'author_id'       => new wfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Author'), 'column' => 'id')),
      'page_id'         => new wfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Page'), 'column' => 'id')),
      ...
      'start_time'      => new wfValidatorTime(array('required' => false)),
      ...
      'end_time'        => new wfValidatorTime(array('required' => false)),
