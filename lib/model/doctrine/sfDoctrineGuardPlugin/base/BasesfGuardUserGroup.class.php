 ...
 * @method sfGuardUserGroup setSiteId()   Sets the current record's "site_id" value
 * @method sfGuardUserGroup setSite()     Sets the current record's "Site" value
 ...
 */
abstract class BasesfGuardUserGroup extends wfDoctrineRecord
{
