<?php
  ...
  $newWindow = isset($options['newWindow']) && $options['newWindow'];
  $targetHtml = $newWindow ? 'target="blank"' : '';
?>
...
<?php if ($item): ?>
  <ul id="a-button-<?php echo $pageid.'-'.$name.'-'.$permid; ?>" class="a-button">
    <li class="a-button-image">
	    ...
	    <?php if ($options['url']): ?>
	      <?php echo '<a class="a-button-link" href="'.$options['url'].'" ' . $targetHtml . '>' .$embed.'</a>' ?>
			<?php else: ?>
	    	<?php echo $embed ?>			
	    <?php endif ?>
    </li>
    <?php if ($options['title']): ?>
      <li class="a-button-title">				
      	<?php if ($options['url']): ?>
					<a class="a-button-link" href="<?php echo $options['url'] ?>" <?php echo $targetHtml ?>><?php echo $options['title'] ?></a>      		
				<?php else: ?>
...
<?php else: ?>
  ...
  <?php if ($options['defaultImage']): ?>
      ...
      <li class="a-button-image">
        ...
        <?php if ($options['link']): ?>
          <a href="<?php echo $options['url'] ?>" <?php echo $targetHtml ?>><?php echo $img ?></a>
        <?php else: ?>
					<?php echo $img ?>
        <?php endif ?>
      </li>
	...
	<?php else: ?>
		<?php if ($options['link'] || $options['url']): ?>
	      ...
	      <li class="a-button-title">
          <a href="<?php echo $options['url'] ?>" <?php echo $targetHtml ?> class="a-button-link"><?php echo $options['title'] ?: $options['url'] ?></a>
	      </li>
		    <?php if ($options['description']): ?>
	      <li class="a-button-description"><?php echo $options['description'] ?></li>
		    <?php endif ?>
