...
/**
 * This is a replacement of sfFormField in an attempt to support attributing errors (and eventually, help) messages
...
class sfFormField
{
  ...
  public function renderRow($attributes = array(), $label = null, $help = null)
  {
    ...
    return strtr($this->parent->getWidget()->getFormFormatter()->formatRow($this->renderLabel($label), $field, $error, $help, null, $this->name), array('%hidden_fields%' => ''));
  }
  ...
  public function renderError()
  {
    ...
    return $this->parent->getWidget()->getFormFormatter()->formatErrorsForRow($error, $this->name);
  }
