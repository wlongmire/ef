...
var AppRouter = Backbone.Router.extend({
    ...
    datelist:function (date) {
        ...
        if (date !== "") {
            ...
            filterObj = {hasFilter:true, filterString:"event_type=3"};    
        }
    ...
    typelist:function (type, filter) {
        ...
        var getIndexOf = {"featured":"event_type=3&discipline=0&location=0&tag=253", "events":"event_type=30&discipline=0&location=0&tag=235", "lectures_talks": "event_type=27&discipline=0&location=0&tag=235", "workshops":"event_type=33&discipline=0&location=0&tag=235", "open_studios":"event_type=32&discipline=0&location=0&tag=235", "tours":"event_type=24&discipline=0&location=0&tag=235", "exhibitions":"date_range=1&event_type=1&discipline=0&location=0&tag=235", "openings":"event_type=21&discipline=0&location=0&tag=235"};
        var filterObj = {};
